    ...
    <Link href={`/products/${product.id}`} className="block group">
      ...
      <div className={`relative aspect-[4/3] overflow-hidden bg-gradient-to-br ${grad}`}>
        ...
        <button
          ...
          className="absolute top-3 right-3 z-10 w-8 h-8 flex items-center justify-center rounded-full glass hover:bg-glass-hover transition-all duration-200 cursor-pointer"
      ...
      <div className="p-4 space-y-2.5">
        ...
        <div className="flex items-center justify-between">
          ...
          <span className="text-xs" style={{ color: "var(--text-muted)" }}>Đã bán {formatCompact(product.sold)}</span>
        </div>
